...
*/
package com.villetainio.travelcardreminder.view;
...
public class TravelCardPagerAdapter extends FragmentStatePagerAdapter {
    private static int NUM_ITEMS = 2;

    public TravelCardPagerAdapter(FragmentManager fm) {
        super(fm);
    }
